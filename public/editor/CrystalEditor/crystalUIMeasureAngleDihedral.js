 ...
 * dihedral 측정 클래스
 * */
export class crystalUIMeasureAngleDihedral {
    ...
    UpdatePreview(wpt, can_finish = false) {
        ...
        if (this._step === 1) {
            ...
            let plane1 = new THREE.Plane().setFromCoplanarPoints(this._preview._pt1, this._preview._pt2, this._preview._pt3);
            let plane2 = new THREE.Plane().setFromCoplanarPoints(this._preview._pt2, this._preview._pt3, this._preview._pt4);
